...
import com.handu.open.dubbo.monitor.tools.SyncUtils;
...
public class ServicesController {
    ...
    public String services(Model model) {
        ...
        if (services != null && services.size() > 0) {
            ...
            for (String service : services) {
                ...
                dubboService.setProviders(SyncUtils.url2Providers(providers));
                ...
                dubboService.setConsumers(SyncUtils.url2Consumers(consumers));
    ...
    @ResponseBody
    public List<DubboService> services1(Model model) {
    	List<DubboService> rows = new ArrayList<DubboService>();
    	Set<String> services = registryContainer.getServices();
